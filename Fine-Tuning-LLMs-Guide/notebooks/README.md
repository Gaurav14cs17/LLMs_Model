...
|---|----------|-------------|------------|--------------|
| 1 | [Basic Fine-Tuning](./01_basic_fine_tuning.ipynb) | Introduction to LLM fine-tuning | ⭐ Beginner | 16GB+ |
| 2 | [LoRA Fine-Tuning](./02_lora_fine_tuning.ipynb) | Parameter-efficient fine-tuning | ⭐⭐ Intermediate | 16GB |
| 3 | [QLoRA Fine-Tuning](./03_qlora_fine_tuning.ipynb) | 4-bit quantized training | ⭐⭐ Intermediate | 6GB ✅ |
| 4 | [DPO Training](./04_dpo_training.ipynb) | Preference optimization | ⭐⭐⭐ Advanced | 16GB |
